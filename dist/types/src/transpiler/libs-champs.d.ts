 ...
 */
export function entreesDe(objet: any): string[];
/**
 ...
 */
export const CHAMPS_DU_PAQUET: Set<string>;
export const MEMBRES_DE_RACINE: Set<string>;
export const CHAMPS_DE_FICHIER: Set<string>;
