# Notes — librairie `settings`

Ce que `lib/settings.bpsl` ne montre pas : la cause d'une valeur, l'histoire d'une forme, la
borne d'une mesure. La source porte ce qui EST, cette note porte le reste.

## settings

LA LIBRAIRIE « settings » — écrite dans le langage qu'elle sert.
