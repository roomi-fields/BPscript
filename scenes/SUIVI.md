...
|--------|--------------|
| **OK_BOTH** | Les deux produisent. Nombre de notes/tokens comparable. |
...
| acceleration | ✅ OK_BOTH | orig: 78 notes. Trans: 78 tokens |
...
| ames | ✅ OK_BOTH | orig: 11 notes. Trans: 11 tokens |
...
| dhati | ✅ OK_BOTH | orig: 17 notes. Trans: 30 tokens |
| dhin | ⚠️ ORIG_NO_MIDI | orig: texte avec period notation. Trans: 82 tokens |
| drum | ✅ OK_BOTH | orig: 12 notes. Trans: 12 tokens |
...
| kss2 | ✅ OK_BOTH | orig: 87 notes. Trans: 96 tokens |
| livecode1 | ✅ OK_BOTH | orig: 27 notes. Trans: 27 tokens |
| livecode2 | ✅ OK_BOTH | orig: 29 notes. Trans: 29 tokens |
...
| ruwet | ✅ OK_BOTH | orig: 123 notes. Trans: 124 tokens |
...
| time-patterns | ✅ OK_BOTH | orig: 8 notes. Trans: 15 tokens |
...
| vina | ✅ OK_BOTH | orig: 5 notes. Trans: 5 tokens |
...
| Catégorie | Nb | Scènes |
|-----------|---:|--------|
| ✅ OK (les deux produisent) | 10 | acceleration, ames, dhati, drum, kss2, livecode1, livecode2, ruwet, time-patterns, vina |
...
- **Transpilé fonctionnel** : 32/44 (73%) — produit des résultats
- **Transpilé crash/abort** : 11/44 (25%) — **bug du transpileur**, pas du moteur
- **Limitation WASM** : 1/44 (2%) — vina3 (stack overflow JS irréductible)
