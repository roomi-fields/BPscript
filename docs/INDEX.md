...
| [SCENES.md](design/SCENES.md) | Hiérarchie de scènes : @scene directive, scoping des flags (héritage top-down, @expose, isolation siblings), sys auto-exposé, fan-out CC/OSC, cycles de feedback | Comprendre le modèle multi-scènes, le scoping des flags, la sémantique @scene/@expose/@alias |
