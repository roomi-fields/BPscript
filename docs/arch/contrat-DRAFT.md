...
| Acteur implicite | matérialise l'acteur `scene` dans l'AST si aucun `actor` (LAN-5/KAI-9 ; renommé `default`→`scene` le 2026-07-30, `hub/decisions/TABLE-DE-LA-LOI.md § Ce qui a été RETIRÉ, et par quoi`) | `bpxAst.js` |
