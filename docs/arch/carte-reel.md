...
- **19 modules** dans `src/transpiler/`, **14527 lignes**.
...
| --- | ---: | ---: | ---: | --- |
| `parser.js` | 7732 | 4 | 1 | BPScript Parser |
| `bpxAst.js` | 3045 | 7 | 1 | POSE LE DESTINATAIRE DE CHAQUE RÉGLAGE SUR LE SAC QUI LE PORTE. |
| `libs.js` | 1342 | 3 | 4 | BPScript Library Loader |
| `actorResolver.js` | 585 | 1 | 1 | BPScript Actor Resolver |
| `libs-bundle.js` | 505 | 2 | 0 | BPScript Libs Bundle Generator |
