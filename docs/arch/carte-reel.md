...
- **24 modules** dans `src/transpiler/`, **16228 lignes**.
...
| --- | ---: | ---: | ---: | --- |
| `parser.js` | 7812 | 7 | 2 | BPScript Parser |
| `resolution.js` | 3177 | 6 | 1 | L'ÉTAGE QUI RÉSOUT — le troisième des quatre, et le seul qui n'avait pas de domicile. |
